...
namespace WebServer
{
    public partial class Form1 : Form
    {
        ...
        public static bool PortSuDung(int port)
        {
            bool portSuDung = false;
            ...
            foreach (IPEndPoint endPoint in ipEndPointsTcp)
            {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (PortSuDung(port))
            {
                ...
                kq = MessageBox.Show("PORT Đang Sử Dụng", "ERROR", MessageBoxButtons.OK);
            ...
            else
            {
                ...
                lbserver.Text = "Server: " + "http://localhost:" + txtPort.Text + "/";
                lbserver.Show();
                btnOpenBrowser.Show();
                timer1.Enabled = true;
            }
        ...
        {
            DialogResult kq = new DialogResult();
            kq = MessageBox.Show("Truy cập " + "http://localhost:" + txtPort.Text + "/", "Are you sure?", MessageBoxButtons.OKCancel);
            if (kq == DialogResult.OK)
                Process.Start("http://localhost:" + txtPort.Text + "/");
        }
